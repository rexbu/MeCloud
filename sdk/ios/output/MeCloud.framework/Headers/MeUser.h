...
public:
    ...
    // 验证码注册
#ifdef __IOS__
    void signup(const char* username, const char* password, MeCallbackBlock callback);
    void login(const char* username, const char* password, MeCallbackBlock callback);
#else

...
# 分别以HTTP、HTTPS协议访问。
access_key_id = os.getenv('OSS_TEST_ACCESS_KEY_ID', 'LTAIssMeSYsRM3Jk')
access_key_secret = os.getenv('OSS_TEST_ACCESS_KEY_SECRET', 'UBh8kh8Xz2DcvgHdeQvlDMm9ocWUmg')
bucket_name = os.getenv('OSS_TEST_BUCKET', 'heimitest')
endpoint = os.getenv('OSS_TEST_ENDPOINT', 'oss-cn-beijing.aliyuncs.com')
sts_role_arn = os.getenv('OSS_STS_ARN', 'acs:ram::1250094474097995:role/heimi-test')
